...
// import hideIcon from "../../stories/assets/hide.png";
// import showIcon from "../../stories/assets/show.png";
...
//                             <Field name="password" type={showPassword ? 'text' : 'password'} id="passwordInput"/>
//                             <Image src= {showPassword ? showIcon : hideIcon } alt="passwordIcon" id="hide" onClick={togglePassword} ></Image>
//                             <div id='error2'>
...
//                         <div id="checkbox">
//                             <label id="remember" >
//                                 <Field type="checkbox" name="rememberMe"  id="accent"/>
//                                 Remember Me
//                             </label>
